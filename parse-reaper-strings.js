...
const buffer3 = Buffer.from(reaTStereoDelayVst3.b2, 'base64');
const writeStream3 = fs.createWriteStream('tStereoDelayVst3-fromReaper');
writeStream3.write(buffer3);
